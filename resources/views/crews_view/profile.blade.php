@extends('layouts.crew_dashboard')
@section('title')
    Profile || Dashboard
@endsection
@section('content')
            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <img src="{{ auth('crew')->user()->image != '' ? asset('uploads/crew' . '/' . auth('crew')->user()->image) : asset('assets/img/profile-img.jpg') }}"
                            alt="{{ auth('crew')->user()->name }}" class="rounded-circle">
                        <h2>{{ auth('crew')->user()->name }}</h2>
                    </div>
                </div>
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-edit" id="profile-edit">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <img id="previewImage"
                                            src="{{ auth('crew')->user()->image != '' ? asset('uploads/crew' . '/' . auth('crew')->user()->image) : asset('assets/img/profile-img.jpg') }}"
                                            alt="Profile">
                                ...
                                <form method="POST" action="{{ route('crews.profile.update') }}">
                                    @csrf
                                    <div class="row mb-3">
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form method="POST" action="{{ route('crews.profile.password.update') }}">
                                    @csrf
                                    <div class="row mb-3">
        ...
        $(document).ready(function() {
            ...
            $('#fileInput').change(function() {
                ...
                if (input.files && input.files[0]) {
                    ...
                    $.ajax({
                        url: "{{ route('crews.profile.picture.update') }}",
                        type: 'POST',
                        data: formData,
                        contentType: false,
                        processData: false,
            ...
            $('a#removeuploadButton').click(function() {
                $.ajax({
                    url: "{{ route('crews.profile.picture.remove') }}",
                    type: 'GET',
                    data: {
                        id: 1
                    },
