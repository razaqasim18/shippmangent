            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row mt-2 needs-validation" method="POST"
                        action="{{ route('crew.update', ['id' => $crew->id]) }}" enctype="multipart/form-data">
                        @if (session('success'))
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control" name="ship_id" id="ship_id" required>
                                    ...
                                    @foreach ($ship as $row)
                                        <option value="{{ $row->id }}"
                                            {{ $row->id == $crew->ship_id ? 'selected' : '' }}>{{ $row->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('ship_id')
